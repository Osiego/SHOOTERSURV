...
class Game:
    def __init__(self):
        ...
        # enemy timer
        self.enemy.event = pygame.event.custom_type()
        pygame.time.set_timer(self.enemy.event, 300)
    ...
    def input(self):
        ...
        pos = self.gun.rect.center + self.gun.player.direction * 50
        Bullet(self.bullet_surf, pos, self.gun.player.direction, (self.all_sprites, self.bullet_sprites))
